...
# 获取当前脚本所在目录的绝对路径
current_dir = os.path.dirname(os.path.abspath('/content/Diffusion-LM/improved-diffusion'))

# 添加 'improved_diffusion' 目录到 sys.path
sys.path.append(os.path.join(current_dir, '/content/Diffusion-LM/improved-diffusion/'))
...
def main():
    ...
    def get_mapping_func(args, diffusion, data):
        ...
        mapping_func = partial(compute_logp, args, model3.to(device))
