...
def get_corpus_rocstory(data_args, model, image_size, padding_mode='block',
    ...
    if data_args.experiment_mode == 'lm':
        ...
        if data_args.modality == 'roc-aug':
            ...
            if split == 'train':
                print('loading form the TRAIN set')
                path = f'/content/Diffusion-LM/datasets/e2e_data/src1_train.txt'
            elif split == 'valid':
                print('loading form the VALID set')
                path = f'/content/Diffusion-LM/datasets/e2e_data/src1_valid.txt'
            elif split == 'test':
                print('loading form the TEST set')
                path = f'/content/Diffusion-LM/datasets/e2e_data/src1_test.txt'
            elif split == 'debug':
